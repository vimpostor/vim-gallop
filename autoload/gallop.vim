func gallop#init()
	...
	xnoremap <silent> <LocalLeader>w :<C-U>call gallop#move#w(1)<CR>
	noremap <silent> <LocalLeader>b :call gallop#move#b(0)<CR>
	xnoremap <silent> <LocalLeader>b :<C-U>call gallop#move#b(1)<CR>
	noremap <silent> <LocalLeader>j :call gallop#move#j(0)<CR>
	xnoremap <silent> <LocalLeader>j :<C-U>call gallop#move#j(1)<CR>
	noremap <silent> <LocalLeader>k :call gallop#move#k(0)<CR>
	xnoremap <silent> <LocalLeader>k :<C-U>call gallop#move#k(1)<CR>
endfunc
